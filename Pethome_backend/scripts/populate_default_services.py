...
CATALOG = {
    "Consultas": {
        ...
        "servicios": [
            ...
            },
            {
                ...
                "duracion": 25,
                "domicilio": False,
                "precios": [("General", "CLINICA", "65.00", "Control de evolucion y puntos")],
            },
            {
                "nombre": "Evaluacion Geriatrica",
                "descripcion": "Consulta integral para pacientes senior con enfoque preventivo.",
                "duracion": 40,
                "domicilio": False,
                "precios": [("General", "CLINICA", "130.00", "Chequeo senior en clinica")],
            },
        ],
    },
    "Vacunacion": {
    ...
    "Prevencion": {
        ...
        "servicios": [
            {
                "nombre": "Desparasitacion Interna",
            ...
            {
                "nombre": "Desparasitacion Externa",
    ...
    "Documentacion": {
        ...
        "servicios": [
            {
                "nombre": "Certificado de Viaje",
                "descripcion": "Evaluacion y emision de certificado sanitario para viaje nacional.",
                "duracion": 30,
                "domicilio": False,
                "precios": [("General", "CLINICA", "110.00", "Emision de certificado en clinica")],
            }
        ],
    },
}
...
def main() -> None:
    vet = Veterinaria.objects.get(slug="default")
    ...
    print({"created": created, "updated": updated, "totals_default": totals})
